...
<body>
    ...
    <header>
        ...
        <div class="top-header">
            <a class="logoImg" href="http://localhost/vizyontakvimi/">
            ...
            <div id="navbar-mobile" class="navbar-mobile">
                <a href="fimler/"><i class="fa-solid fa-film"></i> Filmler</a>
        ...
        <nav class="bottom-header">
            <ul class="bottomUl">
                <li>
                    <a class="navA" href="fimler/"><i class="fa-solid fa-film"></i> Filmler</a>
                </li>
                <li>
